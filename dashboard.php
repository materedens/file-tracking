...
if (isset($_POST['submit'])) {
    ...
    $role = $_POST['role'];
    $status = 1;
    $query = mysqli_query($con, "insert into user(fullName,userEmail,password,gender,department,role,user_status) 
         values('$fullname','$email','$password','$gender','$department','$role','$status')");
                                        ...
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <h2>
                                                    ...
                                                    <?php
                                                    $userlog = mysqli_query($con, "SELECT * FROM userlog");
                                                    $count = mysqli_num_rows($userlog);
                                                    ?><br>
                                                    <?php echo $count; ?>
                                                </h2>
                                                <span>User Log</span><br>
                                            </div>
                                        </div>
                        ...
                        <div class="modal-body">
                            <form action="" method="POST">
                                <div class="login-wrap">
                                    ...
                                    <br>
                                    <input type="radio" name="gender" value="Male" style="zoom:1; vertical-align: middle; margin: 0px;" required> Male
                                    <br>
                                    <input type="radio" name="gender" value="Female" style="zoom:1; vertical-align: middle; margin: 0px;" required> Female
                                    <br>
                                    <input type="radio" name="gender" value="Other" style="zoom:1; vertical-align: middle; margin: 0px;" required> Other
                                    <br><br>
